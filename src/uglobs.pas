...
begin
  ...
  begin
    ...
    begin
      ...
      gRelativeDateDisplay := GetValue(Node, 'RelativeDateDisplay', gRelativeDateDisplay);
...
begin
  ...
  begin
    ...
    SetValue(Node, 'RelativeDateDisplay', gRelativeDateDisplay);
